...
#This is model1 which tests Normal vs everything. In version B (this version) it assumes the image folder structure is:
#   Model_1B_Images
#       Normal
#       Other
...
for cat in categories:
    filelist = glob.glob('./Model_1B_Images/' + cat + '/*')
