...
#This is model3 which tests Normal vs Pneumonia vs everything else. In version B (this version) it assumes the image folder structure is:
#   Model_1B_Images
#       Normal
#       Pneumonia
#       Other
...
categories = ["Normal","Pneumonia", "Other"]
#datasets = ["Train", "Test"]
...
for cat in categories:
    filelist = glob.glob('./Model_3B_Images/' + cat + '/*')
...
#Add 4th dim and set height and width values to normalized values defined above
