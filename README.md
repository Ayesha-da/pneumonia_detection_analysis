...
## Adding a copy of the main branch to preserve the resources folder
...
#### B. Source Format: 
Files are divided into 12 different folders with no differentiators in the folder or image names. There is a csv file which contains the labels for the images. 
#### C. Source Details:
