...
#This is model3 which tests Normal vs Pneumonia vs everything else. In version A (this version) it assumes the image folder structure is:
#   Model_3A_Images
#       Test
#           Normal
#           Pneumonia
...
#There are three categories in two sets:
...
for set_ in datasets:
    for cat in categories:
        filelist = glob.glob('./Model_3A_Images/' + set_ + '/' + cat + '/*')
